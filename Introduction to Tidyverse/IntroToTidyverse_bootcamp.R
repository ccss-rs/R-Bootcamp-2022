...
## Section 4: Reading Data from CSV
...
interviews <- read_csv("https://raw.githubusercontent.com/ccss-rs/R-Workshop-Series/main/Data/SAFI_clean.csv")
str(interviews)

## Section 5: Using tidyr to change layout of dataframes
interviews %>%
...
## Section 5.3 Using Pivot Wider to clean data
